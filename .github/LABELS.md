...
# Component labels (framework architecture)
gh label create "component:provider" --description "AI provider interface" --color "c5def5"
gh label create "component:parser" --description "Document parser related" --color "c5def5"
gh label create "component:analyzer" --description "Analyzer base classes" --color "c5def5"
